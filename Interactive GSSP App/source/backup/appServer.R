...
library(htmlwidgets)
print(getwd())
source("./Interactive GSSP App/source/map.R", local = TRUE)
source("./Interactive GSSP App/source/global.R", local = TRUE)
source("./Interactive GSSP App/source/gPlates.R", local = TRUE)
